...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('admin.types.create') }}" class="btn btn-primary mb-3">Crea Nuovo Progetto</a>
            ...
            <tbody>
                @forelse ($types as $type)
                    <tr>
                        ...
                        <td><a href="{{ $type->type_link }}" target="_blank">Vai alla pagina del progetto</a></td>
                        <td>
